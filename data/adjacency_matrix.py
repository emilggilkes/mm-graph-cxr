...
class AdjacencyMatrices():
    def __init__(self) -> None:
        self.filename = '/n/holyscratch01/protopapas_lab/Everyone/eghitmangilkes/data/imagenome/chest-imagenome/silver_dataset/coco/xray_coco_train.json' # '/home/agun/mimic/dataset/VG/xray_coco_test.json'
    ...
    def anatomy(self):
        ...
        # print(df)
        filename = os.path.join(self.outputdir, 'anatomy_matrix_train.csv')
