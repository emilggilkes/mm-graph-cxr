...
class detectronDetection():
    def __init__(self) -> None:
        ...
        self.image_root = '/n/holyscratch01/protopapas_lab/Everyone/eghitmangilkes/data/mimic/files/' # "/home/agun/mimic/dataset/VG/data/"
    ...
    def registerDataset(self):
        ...
        for d in ["train", "test", "valid"]:
            ...
            DatasetCatalog.register("mimic_cxr_{}".format(d), lambda d=d: self.get_board_dicts(filename))
    ...
    def setup(self):
        ...
        cfg.TEST.EVAL_PERIOD = 50000 # No. of iterations after which the Validation Set is evaluated. 
        # os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)
        cfg.OUTPUT_DIR = '/n/holyscratch01/protopapas_lab/Everyone/eghitmangilkes/obj-detect/output/'
